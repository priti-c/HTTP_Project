/* HTTP Parse : Task 4: Serve Different Responses Based on Path
-----------------------------------------------
- If path = /hello → reply "Hello Student!"
- If path = /time → reply with current system time.
- Else → reply "Unknown Path!" */
